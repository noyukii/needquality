...
When the document you're writing is a skill, read [`SKILL-MECHANICS.md`](writing-for-agents/SKILL-MECHANICS.md) for frontmatter, invocation choice, and router skills.
...
- **By invocation**, skill-specific: see [`SKILL-MECHANICS.md`](writing-for-agents/SKILL-MECHANICS.md).
