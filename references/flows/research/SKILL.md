---
name: research
description: Investigate questions with the smallest research depth that can support the requested answer. Use current, primary, and disconfirming sources when needed; cite claims and expose gaps.
---
