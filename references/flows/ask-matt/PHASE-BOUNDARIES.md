...
| **[handoff](../handoff/SKILL.md)** | Write a portable markdown file and seed a session anywhere with it. |
...
**3. Do you need to hand off?** [handoff](../handoff/SKILL.md) is narrow. You need it only when you are:
...
That list is the whole clause. What [handoff](../handoff/SKILL.md) buys is **portability**: a file that travels. If nothing is travelling, you don't need it.
...
| Secondary (`/compact`, [handoff](../handoff/SKILL.md)) | Lossy       | Less  | Lots         |
