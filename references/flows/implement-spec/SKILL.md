...
Read [tracker](../tracker/SKILL.md) to fetch the spec and tickets.
...
7. Once all tickets are complete, read [code-review](../code-review/SKILL.md) on the PR branch. Fix all issues raised by the code review in a single **implementer subagent**.
