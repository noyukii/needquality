...
or a migration. Also [trust.md](trust.md). Core rules in `SKILL.md`
still apply. Grep the live schema (or `schema.prisma` / `models.py`)
...
unless that *is* the task. Details: [trust.md](trust.md)
irreversible.
